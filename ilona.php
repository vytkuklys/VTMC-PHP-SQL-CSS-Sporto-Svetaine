<?php
    ...
    $title = "Ilonos Statistika";
    
    $sql = "SELECT * FROM ilonos_stats";
    ...
    $content = '<div class="zaidejos-statistika">
                    <img src="images/b.jpg" alt="female playing basketball" class="stats-img">
                    <h2 class="stats-h2">Ilona Brazdeikienė</h2>
