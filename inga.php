<?php
    ...
    $title = "Ingos Statistika";
    
    $sql = "SELECT * FROM ingos_stats";
    ...
    $content = '<div class="zaidejos-statistika">
                    <img src="images/c.jpg" alt="female playing basketball" class="stats-img">
                    <h2 class="stats-h2">Inga Brazdeikytė</h2>
